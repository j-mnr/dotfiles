...
nmap('<Leader>+', '"+P')
-- vim-go
nmap('<Leader>gd', '<Cmd>GoDebug<CR>')
nmap('<Leader>gdc', '<Cmd>GoDebugContinue<CR>')
nmap('<Leader>gdn', '<Cmd>GoDebugNext<CR>')
nmap('<Leader>gta', '<Cmd>GoTest<CR>')
nmap('<Leader>gtf', '<Cmd>GoTestFunc<CR>')
nmap('<Leader>gdtf', '<Cmd>GoDebugTestFunc<CR>')
-- TODO
