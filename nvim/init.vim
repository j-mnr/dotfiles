...
set updatetime=200 " makes the swap file update
" For programming
...
set smartindent
set autoindent
set cindent " This screws `.md` all the indents
set backspace=indent,eol,start " default auto backspace depending on prev char
set nostartofline " default won't push you back to start of line when moving rows
" Searching
...
set completeopt+=noinsert " pum that won't autoselect
set shortmess=aoOtTWIc
